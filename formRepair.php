    ...
    <div class="container-form">
		<div class="row">
			...
			<div class="col-lg-6 lg-2 px-5 pt-5">
		        <form action="codeformRepair.php" method="POST" class="login-email_user">
					...
					<p class="login-text" style="font-size: 2rem; font-weight: 400;">Form Repair </p>
                    ...
                    <div class="form-row">
						<div class="col-lg-7">
                        <select name="build" aria-placeholder="">
                                    <option></option>
                    ...
                    <div class="form-row">
						<div class="col-lg-7">
							<input type="text" class = "form-control my-4 p-2"  placeholder="Phonenumber" name="phone" >
						</div>
					</div>
